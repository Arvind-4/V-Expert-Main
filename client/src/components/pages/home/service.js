        ...
        <div className="max-w-full py-12 px-8 flex flex-col lg:flex-row lg:gap-8 md:place-items-center">
          <div className="text-blue">
            ...
            <p className="text-md sm:text-lg mt-8">
              V-expert is established by professional engineers who have 15+
              years of experience in UAE construction field and We provide best
              quality of the work in each and every installations and ensure the
