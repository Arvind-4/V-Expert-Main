    ...
    <>
      ...
      <section id="About" className="flex items-center justify-center bg-blue">
        <div className="px-4 flex flex-col gap-8 md:flex-row max-w-[1400px] items-center justify-center mx-auto bg-blue">
          <div className="about-img max-w-[500px]">
          ...
          <article className="max-w-[500px] md:max-w-[800px] text-white">
            ...
            <p className="text-md sm:text-lg mt-8">
              V-Expert Technical Services Est is a diversified contract,
              subcontract and general maintenance services organization
              operating throughout the United Arab Emirates. We pride ourselves
              on providing industry-leading turnkey services. Our goal is to
              provide quality, honesty and customer satisfaction with the utmost
              respect.
            </p>
