  ...
  return (
    ...
    >
      ...
      <div className="lg:hidden pr-4 relative text-xl sm:text-3xl">
        <i
          id="address"
          className="fa-xl fa-solid fa-address-book cursor-pointer text-blue mr-3"
          onClick={toggleHeader}
        ></i>
        <div
          className={`${
            header ? "hidden" : ""
          } flex-col absolute top-[40px] right-0 w-[250px] bg-blue text-white p-4 text-[16px]`}
        >
          <div className="flex items-center lg:justify-center">
            <i className="fa-solid fa-phone "></i>
            <a href="tel:+971508446765" className="ml-1">
              +971 508446765, +971 508446737
            </a>
          </div>
          <div className="flex items-center justify-start lg:justify-center lg:mx-8 py-4 lg:py-0">
            <i className="fa-solid fa-envelope"></i>
            <a href="mailto:cs@vexpert.ae" className="ml-1">
              cs@vexpert.ae
            </a>
          </div>
          <div className="flex items-center lg:justify-center">
        ...
        <i
          ...
          } fa-xl cursor-pointer text-blue`}
      ...
      <div
        className={`navlinks ${
          navbar
            ? "hidden"
            : "absolute lg:static left-0 top-0 block min-h-[100vh] lg:min-h-fit w-[250px] lg:w-auto bg-blue"
        } lg:mt-4 lg:pl-6 lg:pr-4 lg:py-2 lg:flex-grow lg:flex lg:items-center lg:justify-between lg:rounded-tl-full text-white lg:bg-blue`}
      >
        <div className="py-8 lg:py-0 flex flex-col lg:flex-row gap-12 lg:gap-0">
          <a href="/" className="py-2 px-4 mr-4">
            Home
          </a>
          <a href="/#About" className="py-2 px-4 mr-4">
            About
          </a>
          <Dropdown name="Packages" links={packages} />
          <Dropdown name="Services" links={services} />
          <a href="#Contact" className="py-2 px-4 mr-4">
            Contact
          </a>
        </div>
        <div className="hidden lg:inline">
          ...
          ></i>
          <SearchResults />
          <a href="/cart" className="ml-4 mr-2">
            <i className="fa-lg fa-sharp fa-solid fa-cart-shopping"></i>
          </a>
        </div>
      </div>
    </nav>
