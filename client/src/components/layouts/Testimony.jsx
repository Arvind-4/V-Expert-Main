...
const Testimony = () => {
  ...
  return (
    <section className="mt-12 pb-12 px-4 flex flex-wrap md:flex-nowrap justify-center md:justify-between gap-2 bg-gray min-h-[450px]">
      <TestimonyForm />
      <article className="pt-12 flex flex-col gap-8 items-center justify-start min-h-[530px]">
        <h1 className="text-5xl sm:text-6xl text-center text-blue">
          Testimonies
        </h1>
        {!loading ? (
